...
parser.add_argument('--model', type=str, default='vicuna-13b', help='Model name for LLM.')
...
# local test
print(llm.generate(prompt="how are you today? i am",
                   temperature=0.5,
                   top_p=1.0,
                   max_tokens=32,
                   n_seqs=4,
...
async def generate_text(prompt: Prompt):
    try:
        generations = llm.generate(prompt=prompt.input,
