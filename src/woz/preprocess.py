...
def process_session(sess_list):
    turn_num = len(sess_list)
    res_dict = {"dataset": "WOZ", "dialogue_session": []}
    for idx in range(turn_num):
        ...
        one_usr_bs, one_usr_bsdx, bs_dict, bs_name_list = update_belief_state(
            one_usr_dict, bs_dict, bs_name_list
        )
        ...
        one_turn_dict["bspn_dict"]["[restaurant]"] = copy.deepcopy(bs_dict)
        one_turn_dict["aspn"] = ""
...
if __name__ == "__main__":
    ...
    in_f = r"./data/pre-training_corpora/raw_data/neural-belief-tracker/data/woz/woz_train_en.json"
    train_list = process_file(in_f)

    in_f = r"./data/pre-training_corpora/raw_data/neural-belief-tracker/data/woz/woz_validate_en.json"
    dev_list = process_file(in_f)

    in_f = r"./data/pre-training_corpora/raw_data/neural-belief-tracker/data/woz/woz_test_en.json"
    ...
    save_path = r"./data/pre-training_corpora/separate_datasets/WOZ/"
