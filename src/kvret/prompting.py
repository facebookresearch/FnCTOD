...
from src.kvret.postprocess import (
    get_data_split,
    load_schema,
)
from src.utils import *
...
from src.kvret.schema2function import schema2function
...
if __name__ == "__main__":
    ...
    # save data path
    data_path = f"./data/pre-training_corpora/prompting_data/kvret/"
    ...
    for dial_id, turns in data.items():
        ...
        for service in schema:
            if service["service_name"] == "car_assistant":
