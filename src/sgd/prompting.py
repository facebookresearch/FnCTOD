...
from src.sgd.postprocess import (
    get_data_split, 
    load_schema, 
)
...
from src.sgd.schema2function import schema2function
...
if __name__ == '__main__':
    ...
    schema = load_schema()
    train_data, dev_data, test_data = get_data_split(return_list=False)
    ...
    # save data path
    data_path = f"./data/pre-training_corpora/prompting_data/sgd/"
