...
all_acts = ['confirm', 'goodbye', 'inform', 'inform_count', 'notify_failure', 
            'notify_success', 'offer', 'offer_intent', 'request', 'reqmore']
                ...
                for value in action["values"]:
                    if value:
                        try:
                            ...
                            print(f"value {slot} can not be found in utterance {utterance}!")
    return utterance
...
def zip_turn(one_turn_list, prev_bs_dict, prev_bs_name_list):
    ...
    return usr_uttr, bs_text, bsdx_text, system_uttr, delx_system_uttr, action_text, action_dict, db, bs_dict, bs_name_list
...
def process_session_list(session_list):
    ...
    for idx in range(turn_num):
        ...
        one_usr_uttr, one_usr_bs, one_usr_bsdx, one_system_uttr, one_system_uttr_delx, one_system_action, da_dict, db, \
