...
GENERAL_TYPO = {
        ...
        # others
        "y":"yes", "any":"dontcare", "n":"no", "does not care":"dontcare", "not men":"none", "not":"none", "not mentioned":"none", "not present":"none",
...
def fix_mismatch_jason_2020(slot, val):
    ...
    if val in ["churchills college", "churchhill college", "churchill", "the churchill college"]: 
    ...
    if val in ["sheeps green and lammas land park fen causeway", "sheeps green and lammas land park"]: 
