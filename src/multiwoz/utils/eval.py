...
class MultiWozEvaluator(object):
    ...
    def validation_metric(self, data):
        ...
        success, match, req_offer_counts, dial_num, total_successes, total_matches = self.context_to_response_eval(data,
    ...
    def _get_metric_results(self, data, domain='all', file_list=None):
        ...
        success, match, req_offer_counts, dial_num, total_successes, total_matches = self.context_to_response_eval(data, file_list,
                                                    same_eval_as_cambridge=self.cfg.same_eval_as_cambridge)
        req_slots_acc = {}
            ...
            for turn_num, turn in enumerate(dial):
                ...
                if self.cfg.enable_dspn:
                    ...
                    if self.cfg.enable_bspn and not self.cfg.use_true_bspn_for_ctr_eval and \
                        (self.cfg.bspn_mode == 'bspn' or self.cfg.enable_dst):
