...
class Config20:
    ...
    def _multiwoz_damd_init(self):
        ...
        self.domain_file_path = (
            self.data_prefix + "/multi-woz-2.0-processed/domain_files.json"
        )
...
class Config21:
    ...
    def _multiwoz_damd_init(self):
        ...
        self.domain_file_path = (
            self.data_prefix + "/multi-woz-2.1-processed/domain_files.json"
        )
        self.slot_value_set_path = self.data_prefix + "/db/value_set_processed.json"
...
class Config22:
    ...
    def _multiwoz_damd_init(self):
        self.vocab_path_train = self.data_prefix + "/multi-woz-2.2-processed/vocab"
        self.data_path = self.data_prefix + "/multi-woz-2.2-processed/"
        self.data_file = "data_for_damd.json"
        self.dev_list = self.data_prefix + "/multi-woz/valListFile.json"
        self.test_list = self.data_prefix + "/multi-woz/testListFile.json"
        ...
        self.domain_file_path = (
            self.data_prefix + "/multi-woz-2.2-processed/domain_files.json"
        )
        self.slot_value_set_path = self.data_prefix + "/db/value_set_processed.json"
...
class Config23:
    ...
    def _multiwoz_damd_init(self):
        ...
        self.domain_file_path = (
            self.data_prefix + "/multi-woz-2.3-processed/domain_files.json"
        )
        self.slot_value_set_path = self.data_prefix + "/db/value_set_processed.json"
