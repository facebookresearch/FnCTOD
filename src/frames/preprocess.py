...
def zip_turn(usr_dict, system_dict, prev_bs_dict, prev_bs_name_list, domain):
    ...
    res_bs_dict, res_bs_name_list = update_user_belief_state(
        prev_bs_dict, prev_bs_name_list, usr_dict
    )
...
def build_session_list(in_item):
    ...
    one_turn_list = []
    target_speaker = "user"
    target_map = {"user": "wizard", "wizard": "user"}
...
def process_session(session_list, domain):
    ...
    res_dict = {"dataset": "Frames", "dialogue_session": []}
