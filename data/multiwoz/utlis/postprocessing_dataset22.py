...
if __name__ == "__main__":
    ...
    os.makedirs(r"../data/multi-woz-2.2-fine-processed/", exist_ok=True)
    ...
    out_f = r"../data/multi-woz-2.2-fine-processed/multiwoz-fine-processed-train.json"
    ...
    out_f = r"../data/multi-woz-2.2-fine-processed/multiwoz-fine-processed-dev.json"
    with open(out_f, "w") as outfile:
    ...
    out_f = r"../data/multi-woz-2.2-fine-processed/multiwoz-fine-processed-test.json"
    with open(out_f, "w") as outfile:
