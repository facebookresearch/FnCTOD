...
class _Config:
    ...
    def _multiwoz_damd_init(self):
        ...
        self.domain_file_path = "data/multi-woz-2.2-processed/domain_files.json"
        self.slot_value_set_path = "db/value_set_processed.json"
        self.multi_acts_path = (
            "data/multi-woz-2.2-processed/multi_act_mapping_train.json"
        )
        ...
        # evaluation settings
        self.eval_load_path = (
            "experiments/all_0729_sd11_lr0.0001_bs2_ga16/epoch43_trloss0.56_gpt2"
        )
