...
def get_db_values(
    ...
    with open("data/multi-woz-2.1-processed/bspn_word_collection.json", "w") as f:
...
class DataPreprocessor(object):
    def __init__(self):
        ...
        self.delex_sg_valdict_path = (
            "data/multi-woz-2.1-processed/delex_single_valdict.json"
        )
        self.delex_mt_valdict_path = (
            "data/multi-woz-2.1-processed/delex_multi_valdict.json"
        )
